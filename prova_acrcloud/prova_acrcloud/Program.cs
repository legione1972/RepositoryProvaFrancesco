...
namespace ACRCloudRecognitionTest
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine(new System.IO.FileInfo(@"test.mp3").FullName);
            Console.ReadLine();
            var config = new Dictionary<string, object>();
            // Replace "XXXXXXXX" below with your project's host, access_key and access_secret
            config.Add("host", "XXXXXXXX");
            config.Add("access_key", "10Wf8HEvpGxgcMYV");
            config.Add("access_secret", "3PXPo29KFxJdMF4DvKs23vJWdHJMSVTX");
            ...
            string result = re.RecognizeByFile(new System.IO.FileInfo(@"test.mp3").FullName, 0);
